package com.example.soundspace.api.security;

import com.example.soundspace.api.jwt.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/v1/users/sign-up", "/api/v1/users/login", "/api/v1/users/authority",
                        "/api/v1/users/reissue", "/api/v1/users/logout", "/api/v1/users/{username}/profiles").permitAll()
