    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "http://test-env.eba-gatb5mmj.ap-northeast-2.elasticbeanstalk.com/api/v1/users/me",
          {
            headers: {
  ...
  const handleChange = async () => {
    try {
      ...
      const response = await axios.patch(
        "http://test-env.eba-gatb5mmj.ap-northeast-2.elasticbeanstalk.com/api/v1/users/me/update",
        {
